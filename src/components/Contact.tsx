...
export function Contact() {
  return (
    <section id="contact" className="bg-bg-primary py-[5.5rem] text-center">
      <div className="mx-auto max-w-[1200px] px-6">
        <SectionTitle direction="down">Get In Touch</SectionTitle>

        <Reveal delay={0.1}>
          <p className="mx-auto -mt-6 mb-10 text-[1.05rem] leading-[1.8] text-text-secondary">
        ...
        <Reveal direction="zoom" delay={0.2}>
          <div className="mb-8 flex flex-wrap justify-center gap-5">
            <a
              ...
              className="inline-flex items-center gap-3 rounded-[4px] bg-[#25d366] px-8 py-4 text-[0.95rem] font-semibold tracking-[0.03em] text-white shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 hover:-translate-y-1 hover:bg-[#1ebe5c] hover:shadow-[0_10px_28px_rgba(37,211,102,0.35)]">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 rounded-[4px] px-8 py-4 text-[0.95rem] font-semibold tracking-[0.03em] text-white shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300 hover:-translate-y-1 hover:brightness-110 hover:shadow-[0_10px_28px_rgba(220,39,67,0.35)]"
              style={{
                background:
